...
export default class PlayerCardBack extends Component {
  ...
  render () {
    ...
    return (
      ...
      <View style = {[styles.playerCard, {backgroundColor: _validatePrimaryTeamColor()}]}>
          ...
          <View><Text style = {[styles.playerName, {top:10}]}>{this.props.firstName} {this.props.lastName}</Text></View>

          <View style={[styles.statsHolder, {backgroundColor: _validatePrimaryTeamColor()}]}>
            <View><Text style = {[styles.stats]}>{this.props.stat1}{'\n'}<Text style = {[styles.statsLabel]}>{this.props.statLabel1}</Text></Text></View>
            <View><Text style = {[styles.stats]}>{this.props.stat2}{'\n'}<Text style = {[styles.statsLabel]}>{this.props.statLabel2}</Text></Text></View>
            <View><Text style = {[styles.stats]}>{this.props.stat3}{'\n'}<Text style = {[styles.statsLabel]}>{this.props.statLabel3}</Text></Text></View>
            <View><Text style = {[styles.stats]}>{this.props.stat4}{'\n'}<Text style = {[styles.statsLabel]}>{this.props.statLabel4}</Text></Text></View>
            <View><Text style = {[styles.stats]}>{this.props.stat5}{'\n'}<Text style = {[styles.statsLabel]}>{this.props.statLabel5}</Text></Text></View>
            <View><Text style = {[styles.stats]}>{this.props.stat6}{'\n'}<Text style = {[styles.statsLabel]}>{this.props.statLabel6}</Text></Text></View>
          </View>
